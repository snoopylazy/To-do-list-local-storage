...
function createItem(item) {
  ...
  showNotification('Item added successfully!', 5000); // Show for 5 seconds
  location.reload();
}
...
function deleteItem(i) {
  ...
  localStorage.setItem('items', JSON.stringify(itemsArray));
  showNotification('Item deleted successfully!', 5000); // Show for 5 seconds
  location.reload();
}
...
function toggleComplete(i) {
  ...
  localStorage.setItem('items', JSON.stringify(itemsArray));
  showNotification('Item marked as ' + (itemsArray[i].completed ? 'completed' : 'incomplete') + '!', 5000); // Show for 5 seconds
  displayItems();
}
